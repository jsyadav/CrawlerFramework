...
log = logging.getLogger('FrigidaireConnector')

class FrigidaireConnector(BaseConnector):
    
    ''' 
    Sample url = 'http://www.frigidaire.com/products/Kitchen/Refrigerators/FPHB2899LF.aspx?tab=reviews#reviews'
    '''
    ...
    def __addReviews(self):
            ...
            try:
                ...
                reviews = [x.findParent('li') for x in self.soup.findAll('div','reviewInfo')]
                print '******************************************************'
                print 'no. of reviews...'
                print len(reviews)
            ...
            for review in reviews:
                ...
                try:
                    ...
                    page['posted_date'] = datetime.strftime(datetime.strptime(stripHtml(date_str),'%m/%d/%Y'),"%Y-%m-%dT%H:%M:%SZ")
