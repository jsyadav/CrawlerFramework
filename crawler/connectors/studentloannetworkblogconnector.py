...
log = logging. getLogger("StudentLoanNetworkBlogconnector")

class StudentLoanNetworkBlogconnector(BaseConnector):
    '''Connector for studentloannetwork blog
    '''
    ...
    def fetch(self):
        ...
        sample urls
        forum url: http://blog.studentloannetwork.com/category/consolidation/
        thread url: http://blog.studentloannetwork.com/student-loans/when-may-i-consolidate-my-federal-loans/
        """
        self.genre = "Review"
        try:
