...
from webmdexchangesconnector import WebmdExchangesConnector
import logging

log = logging.getLogger('WebmdForumsConnector')
class WebmdForumsConnector(WebmdExchangesConnector):
    '''
    for this connector
    The input URL segment is exchanges.webmd.com
    It finds the thread and add tasks with forums.webmd.com
    Since there is only one connector is availbale per url segment
    This class is created and inherits the Webm
    '''
    pass